<script>
    ...
    onMount(() => {
        ...
        // Once again almost same as desktop
...
{#if pageIsLoaded}
    ...
    <div style={verticalDisplay ? "" : "display: flex;"}>
        <div transition:scale>
            <Biography mobile=true mobileVertical={verticalDisplay} mobileFullSize={!showSpot} />
        </div>
        ...
        {#if showSpot}
            <div transition:scale style="display: inline-block;">
                <TerminalWindow
                    ...
                    mobile=true
                >
                    <div style="{verticalDisplay ? "display: flex; align-items: center; height: 100%;" : ""} ">
                        <div style="justify-content: center; display: flex">
                            <img
                                ...
                                style="{verticalDisplay != true ? "min-width: 100%;" : "max-width: 20vh"}"
                            />
                        </div>
